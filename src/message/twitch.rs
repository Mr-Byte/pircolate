...
pub fn user<'a>(username: &str, real_name: &str) -> Result<Message<'a>> {
...
pub fn cap_req<'a>(cap: &str) -> Result<Message<'a>> {
...
pub fn join<'a>(channels: &str, keys: Option<&str>) -> Result<Message<'a>> {
...
pub fn priv_msg<'a>(targets: &str, message: &str) -> Result<Message<'a>> {
